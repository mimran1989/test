...
import TheGrid from '../features/questions/gridQuestions';
...
Then('{actor} will see the resource role {string} in the order sheet', (actor, roleName) => actor.attemptsTo(Ensure.that(TheGrid.has.aRoleNamed(roleName))));
